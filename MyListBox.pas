...
begin
  ...
  // Создали список который может хранить в себе строки

  OnDblClick := DblClick; // Событие двойной клик у ListBox
end;

destructor TMyListBox.Destroy;
begin
  FList.Destroy; // Уничтожение Списка
